...
% Script to determine anaerobic growth rate of E.coli on glucose
...
% The growth of E. coli on glucose can be simulated under anaerobic conditions. 
...
% of a metabolite is a negative flux. To prevent oxygen uptake, enter:

model = changeRxnBounds(model,'EX_o2(e)',0,'l');

% By setting the lower bound of the oxygen uptake reaction to zero 
% should simulate anaerobic operation. 
