...
% -10, a biologically realistic uptake rate. By convention, the import 
...
% Set optimization objective to Ec_biomass_iAF1260_core_59p81M

model = changeObjective(model,'Ec_biomass_iAF1260_core_59p81M');

% Perform FBA with Ec_biomass_iAF1260_core_59p81M as the objective, 

FBAsolution = optimizeCbModel(model,'max')

% FBAsolution.f then gives the value of the objective function (Z) 
