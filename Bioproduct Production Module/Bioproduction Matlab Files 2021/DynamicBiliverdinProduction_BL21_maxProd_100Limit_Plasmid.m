% DynamicBiliverdinProduction_BL21_maxProd_100Limit_Plasmid.m
clear;
...
title('Maximum Biliverdin Production at 100g/L Biomass Limit'); xlabel('HEMEOX (mmol/(gDW h))'); ylabel('Biliverdin Concentration (g/L)');
axis tight

figure(5);
plot(prodFlux, biliTime)
title('Production Time to Reach 100 g/L of Biomass'); xlabel('HEMEOX (mmol/(gDW h))'); ylabel('Maximum Production Time (h)');
axis tight
