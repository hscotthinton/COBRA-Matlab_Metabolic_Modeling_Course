% Biliverdin_Production_PPP_BL21_Plasmid.m
clear;
...
% title('Growth-rate Phenotype Phase Plane Analysis with No Plasmid'); 
title('Growth-rate Phenotype Phase Plane Analysis with Plasmid'); 
