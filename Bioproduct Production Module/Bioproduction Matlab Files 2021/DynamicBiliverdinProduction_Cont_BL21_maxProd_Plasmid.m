% DynamicBiliverdinProduction_Cont_BL21_maxProd_Plasmid.m
clear;
...
[concentrationMatrix,excRxnNames,timeVec,biomassVec] = ...
    dynamicFBA(modeltest,substrateRxns,initConcentrations, initBiomass, timeStep, nSteps, plotRxns, exclUptakeRxns );
