% Biliverdin_Nutrient_ShadowPrices_BL21.m
clear;
...
minerals = {'ca2[e]','cl[e]','co2[e]','cobalt2[e]','cu2[e]','fe2[e]','fe3[e]','h[e]','h2o[e]',...
'k[e]','mg2[e]','mn2[e]','mobd[e]','na1[e]','tungs[e]','zn2[e]','ni2[e]','sel[e]','slnt[e]','so4[e]',...
'nh4[e]','pi[e]','cbl1[e]'};

[tmp,preNumber] = ismember(minerals,model.mets);
mineralsSP = FBAsolution.y(preNumber);
metIncrease = 1./mineralsSP;

printLabeledData(minerals',mineralsSP)
