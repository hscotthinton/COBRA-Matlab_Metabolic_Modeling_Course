% Biliverdin_Glycerol_Production_GrowthRate_PPP_BL21_Plasmid.m
clear;
...
model = changeRxnBounds(model,'HEMEOX',0.5,'l'); % Large production
model = changeObjective(model,'Ec_biomass_iJO1366_core_53p95M');
% model = changeRxnBounds(model,'HOprotein',0.0102,'l');
 
% dynamicFBA
substrateRxns = {'EX_glc(e)'};
initConcentrations = [40];%40
initBiomass = 0.01;
timeStep = 0.25;
nSteps = 32;
% plotRxns = {'Ec_biomass_iJO1366_core_53p95M',' EX_biliverdin(e)','EX_glyc(e)'};
plotRxns = {'EX_glc(e)','EX_biliverdin(e)'};
