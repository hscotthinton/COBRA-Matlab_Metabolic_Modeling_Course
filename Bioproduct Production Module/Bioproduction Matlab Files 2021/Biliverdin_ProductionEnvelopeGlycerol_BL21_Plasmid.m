% Biliverdin_ProductionEnvelopeGlycerol_BL21_Plasmid.m
clear;
...
title('Biliverdin/Glycerol Production Envelope'); xlabel('Biomass (mmol/g DW-hr)'); ylabel('EX-biliverdin(e)(mmol/g DW-hr)')
axis tight
