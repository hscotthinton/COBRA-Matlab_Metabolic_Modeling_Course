...
% model = changeRxnBounds(model,'EX_glyc(e)',-18,'l');
model = changeRxnBounds(model,'EX_o2(e)',-10,'l');
model = changeRxnBounds(model,'EX_biliverdin(e)',0.68,'l'); % Maximum HEMEOX production
% model = changeRxnBounds(model,'EX_biliverdin(e)',0.01,'l'); % Large production
...
[biomassValues,targetValues] = multiProductionEnvelopeInorg(model,deletions,biomassRxn,false,20,false);