% Biliverdin_Carbon_Source_ReducedCosts_BL21.m
clear;
...
% model = changeRxnBounds(model,'EX_biliverdin(e)',1,'u');
...
disp(' ');
disp('Carbon Source Reduced Costs')
keyReactions = {'EX_fru(e)','EX_glc(e)','EX_glyc(e)','EX_lcts(e)','EX_malt(e)','EX_mnl(e)','EX_man(e)','EX_rmn(e)','EX_rib-D(e)','EX_xyl-D(e)'};
  
[tmp,preNumber] = ismember(keyReactions,model.rxns);
keyReactionsRC = FBAsolution.w(preNumber);

printLabeledData(keyReactions',keyReactionsRC)
